...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Kanit:wght@300&family=Kdam+Thmor+Pro&family=Oswald:wght@300&family=Vina+Sans&display=swap" rel="stylesheet">
...
<body>
    <div class="header-container"> 
        <h1 class="caesar-title">Caesar</h1>
    </div>
